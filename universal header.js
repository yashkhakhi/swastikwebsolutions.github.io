  ...
  connectedCallback() {
    ...
    <header>
      <div class="header1">
        ...
        <h4>Follo Us : 
          <a href="https://www.linkedin.com/company/swastik-web-solutions" target="_blank"><i class="fab fa-linkedin" title="Linked in"></i></a>
          <a href="https://g.page/r/CZ9JaDxksbHWEAE" target="_blank"><i class="fab fa-google" title="Google"></i></a>
  ...
  connectedCallback() {
    ...
    <div class="footer">
        <div class="grid1">
            ...
            <br><br>
            <a href="https://www.upwork.com/freelancers/~01220afa54de1d1213?viewMode=1" target="_blank"><img src="Image/upwork.png" alt="Company Trust" width="100%"></a>
        ...
        <div class="grid3">
            ...
            <div class="icon">
                <h4>Follow Us :</h4>
                <ul>
                  <li><a href="mailto:swastikwebsolutions21@gmail.com"><i class="fa fa-envelope" aria-hidden="true" title="mail"></i></a></li>
                  <li><a href="https://www.linkedin.com/company/swastik-web-solutions" target="_blank"><i class="fa fa-linkedin" aria-hidden="true" title="Linked in"></i></a></li>
                  <li><a href="https://g.page/r/CZ9JaDxksbHWEAE" target="_blank"><i class="fab fa-google" aria-hidden="true" title="Google"></i></a></li>
                </ul>
            </div>
