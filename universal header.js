  ...
  connectedCallback() {
    ...
    <header>
      <div class="header1">
        ...
        <h4>Follo Us : 
          <a href="https://www.linkedin.com/company/swastik-web-solutions"><i class="fab fa-linkedin"></i></a>
          <a href="https://g.page/r/CZ9JaDxksbHWEAE"><i class="fab fa-google"></i></a>
        </h4>
      </div>
      <div class="header2">
        <div class="logo">
